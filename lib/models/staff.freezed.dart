...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Staff&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.realName, realName) || other.realName == realName)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other.roles, roles));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,realName,phone,notes,const DeepCollectionEquality().hash(roles));

@override
String toString() {
  return 'Staff(uuid: $uuid, realName: $realName, phone: $phone, notes: $notes, roles: $roles)';
}
...
@useResult
$Res call({
 String uuid, String realName, String? phone,@JsonKey(includeFromJson: false, includeToJson: false) String? notes, Set<StaffRole> roles
});
...
/// Create a copy of Staff
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? realName = null,Object? phone = freezed,Object? notes = freezed,Object? roles = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uuid,  String realName,  String? phone, @JsonKey(includeFromJson: false, includeToJson: false)  String? notes,  Set<StaffRole> roles)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Staff() when $default != null:
return $default(_that.uuid,_that.realName,_that.phone,_that.notes,_that.roles);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uuid,  String realName,  String? phone, @JsonKey(includeFromJson: false, includeToJson: false)  String? notes,  Set<StaffRole> roles)  $default,) {final _that = this;
switch (_that) {
case _Staff():
return $default(_that.uuid,_that.realName,_that.phone,_that.notes,_that.roles);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uuid,  String realName,  String? phone, @JsonKey(includeFromJson: false, includeToJson: false)  String? notes,  Set<StaffRole> roles)?  $default,) {final _that = this;
switch (_that) {
case _Staff() when $default != null:
return $default(_that.uuid,_that.realName,_that.phone,_that.notes,_that.roles);case _:
  return null;
...
class _Staff implements Staff {
  const _Staff({required this.uuid, required this.realName, this.phone, @JsonKey(includeFromJson: false, includeToJson: false) this.notes, final  Set<StaffRole> roles = const <StaffRole>{}}): _roles = roles;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Staff&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.realName, realName) || other.realName == realName)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other._roles, _roles));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,realName,phone,notes,const DeepCollectionEquality().hash(_roles));
...
/// Create a copy of Staff
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uuid = null,Object? realName = null,Object? phone = freezed,Object? notes = freezed,Object? roles = null,}) {
  return _then(_Staff(
uuid: null == uuid ? _self.uuid : uuid // ignore: cast_nullable_to_non_nullable
as String,realName: null == realName ? _self.realName : realName // ignore: cast_nullable_to_non_nullable
as String,phone: freezed == phone ? _self.phone : phone // ignore: cast_nullable_to_non_nullable
