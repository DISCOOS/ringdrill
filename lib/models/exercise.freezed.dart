...
/// migration rung: an old plan *is* a ring route, and says so by omission.
 ExerciseMode get mode; int get executionTime; int get evaluationTime; int get rotationTime; List<Station> get stations; List<List<SimpleTimeOfDay>> get schedule; SimpleTimeOfDay get endTime; ExerciseMetadata? get metadata; String? get templateId;/// Per-scope value overrides for plan-global variables, keyed by
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uuid,index,name,startTime,numberOfTeams,numberOfRounds,mode,executionTime,evaluationTime,rotationTime,const DeepCollectionEquality().hash(stations),const DeepCollectionEquality().hash(schedule),endTime,metadata,templateId,const DeepCollectionEquality().hash(variableOverrides),methodMd,learningGoalsMd,trainingFocusMd,orderFormatMd,executionTipsMd,commsMd]);

@override
String toString() {
  return 'Exercise(uuid: $uuid, index: $index, name: $name, startTime: $startTime, numberOfTeams: $numberOfTeams, numberOfRounds: $numberOfRounds, mode: $mode, executionTime: $executionTime, evaluationTime: $evaluationTime, rotationTime: $rotationTime, stations: $stations, schedule: $schedule, endTime: $endTime, metadata: $metadata, templateId: $templateId, variableOverrides: $variableOverrides, methodMd: $methodMd, learningGoalsMd: $learningGoalsMd, trainingFocusMd: $trainingFocusMd, orderFormatMd: $orderFormatMd, executionTipsMd: $executionTipsMd, commsMd: $commsMd)';
}
...
@useResult
$Res call({
 String uuid, int index, String name, SimpleTimeOfDay startTime, int numberOfTeams, int numberOfRounds, ExerciseMode mode, int executionTime, int evaluationTime, int rotationTime, List<Station> stations, List<List<SimpleTimeOfDay>> schedule, SimpleTimeOfDay endTime, ExerciseMetadata? metadata, String? templateId, Map<String, String> variableOverrides,@JsonKey(includeFromJson: false, includeToJson: false) String? methodMd,@JsonKey(includeFromJson: false, includeToJson: false) String? learningGoalsMd,@JsonKey(includeFromJson: false, includeToJson: false) String? trainingFocusMd,@JsonKey(includeFromJson: false, includeToJson: false) String? orderFormatMd,@JsonKey(includeFromJson: false, includeToJson: false) String? executionTipsMd,@JsonKey(includeFromJson: false, includeToJson: false) String? commsMd
});
...
as ExerciseMode,executionTime: null == executionTime ? _self.executionTime : executionTime // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uuid,  int index,  String name,  SimpleTimeOfDay startTime,  int numberOfTeams,  int numberOfRounds,  ExerciseMode mode,  int executionTime,  int evaluationTime,  int rotationTime,  List<Station> stations,  List<List<SimpleTimeOfDay>> schedule,  SimpleTimeOfDay endTime,  ExerciseMetadata? metadata,  String? templateId,  Map<String, String> variableOverrides, @JsonKey(includeFromJson: false, includeToJson: false)  String? methodMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? learningGoalsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? trainingFocusMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? orderFormatMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? executionTipsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? commsMd)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.uuid,_that.index,_that.name,_that.startTime,_that.numberOfTeams,_that.numberOfRounds,_that.mode,_that.executionTime,_that.evaluationTime,_that.rotationTime,_that.stations,_that.schedule,_that.endTime,_that.metadata,_that.templateId,_that.variableOverrides,_that.methodMd,_that.learningGoalsMd,_that.trainingFocusMd,_that.orderFormatMd,_that.executionTipsMd,_that.commsMd);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uuid,  int index,  String name,  SimpleTimeOfDay startTime,  int numberOfTeams,  int numberOfRounds,  ExerciseMode mode,  int executionTime,  int evaluationTime,  int rotationTime,  List<Station> stations,  List<List<SimpleTimeOfDay>> schedule,  SimpleTimeOfDay endTime,  ExerciseMetadata? metadata,  String? templateId,  Map<String, String> variableOverrides, @JsonKey(includeFromJson: false, includeToJson: false)  String? methodMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? learningGoalsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? trainingFocusMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? orderFormatMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? executionTipsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? commsMd)  $default,) {final _that = this;
switch (_that) {
case _Exercise():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uuid,  int index,  String name,  SimpleTimeOfDay startTime,  int numberOfTeams,  int numberOfRounds,  ExerciseMode mode,  int executionTime,  int evaluationTime,  int rotationTime,  List<Station> stations,  List<List<SimpleTimeOfDay>> schedule,  SimpleTimeOfDay endTime,  ExerciseMetadata? metadata,  String? templateId,  Map<String, String> variableOverrides, @JsonKey(includeFromJson: false, includeToJson: false)  String? methodMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? learningGoalsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? trainingFocusMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? orderFormatMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? executionTipsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? commsMd)?  $default,) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.uuid,_that.index,_that.name,_that.startTime,_that.numberOfTeams,_that.numberOfRounds,_that.mode,_that.executionTime,_that.evaluationTime,_that.rotationTime,_that.stations,_that.schedule,_that.endTime,_that.metadata,_that.templateId,_that.variableOverrides,_that.methodMd,_that.learningGoalsMd,_that.trainingFocusMd,_that.orderFormatMd,_that.executionTipsMd,_that.commsMd);case _:
  return null;
