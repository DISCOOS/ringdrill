...
mixin _$Exercise {
 ...
 String get uuid; int get index; String get name; SimpleTimeOfDay get startTime; int get numberOfTeams; int get numberOfRounds; int get executionTime; int get evaluationTime; int get rotationTime; List<Station> get stations; List<List<SimpleTimeOfDay>> get schedule; SimpleTimeOfDay get endTime; ExerciseMetadata? get metadata; String? get templateId;// Markdown brief fields — stored as exercises/<uuid>/<field>.md, not in JSON.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uuid,index,name,startTime,numberOfTeams,numberOfRounds,executionTime,evaluationTime,rotationTime,const DeepCollectionEquality().hash(stations),const DeepCollectionEquality().hash(schedule),endTime,metadata,templateId,methodMd,learningGoalsMd,trainingFocusMd,orderFormatMd,executionTipsMd,commsMd]);
...
@useResult
$Res call({
 String uuid, int index, String name, SimpleTimeOfDay startTime, int numberOfTeams, int numberOfRounds, int executionTime, int evaluationTime, int rotationTime, List<Station> stations, List<List<SimpleTimeOfDay>> schedule, SimpleTimeOfDay endTime, ExerciseMetadata? metadata, String? templateId,@JsonKey(includeFromJson: false, includeToJson: false) String? methodMd,@JsonKey(includeFromJson: false, includeToJson: false) String? learningGoalsMd,@JsonKey(includeFromJson: false, includeToJson: false) String? trainingFocusMd,@JsonKey(includeFromJson: false, includeToJson: false) String? orderFormatMd,@JsonKey(includeFromJson: false, includeToJson: false) String? executionTipsMd,@JsonKey(includeFromJson: false, includeToJson: false) String? commsMd
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uuid,  int index,  String name,  SimpleTimeOfDay startTime,  int numberOfTeams,  int numberOfRounds,  int executionTime,  int evaluationTime,  int rotationTime,  List<Station> stations,  List<List<SimpleTimeOfDay>> schedule,  SimpleTimeOfDay endTime,  ExerciseMetadata? metadata,  String? templateId, @JsonKey(includeFromJson: false, includeToJson: false)  String? methodMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? learningGoalsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? trainingFocusMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? orderFormatMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? executionTipsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? commsMd)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uuid,  int index,  String name,  SimpleTimeOfDay startTime,  int numberOfTeams,  int numberOfRounds,  int executionTime,  int evaluationTime,  int rotationTime,  List<Station> stations,  List<List<SimpleTimeOfDay>> schedule,  SimpleTimeOfDay endTime,  ExerciseMetadata? metadata,  String? templateId, @JsonKey(includeFromJson: false, includeToJson: false)  String? methodMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? learningGoalsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? trainingFocusMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? orderFormatMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? executionTipsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? commsMd)  $default,) {final _that = this;
switch (_that) {
case _Exercise():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uuid,  int index,  String name,  SimpleTimeOfDay startTime,  int numberOfTeams,  int numberOfRounds,  int executionTime,  int evaluationTime,  int rotationTime,  List<Station> stations,  List<List<SimpleTimeOfDay>> schedule,  SimpleTimeOfDay endTime,  ExerciseMetadata? metadata,  String? templateId, @JsonKey(includeFromJson: false, includeToJson: false)  String? methodMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? learningGoalsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? trainingFocusMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? orderFormatMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? executionTipsMd, @JsonKey(includeFromJson: false, includeToJson: false)  String? commsMd)?  $default,) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.uuid,_that.index,_that.name,_that.startTime,_that.numberOfTeams,_that.numberOfRounds,_that.executionTime,_that.evaluationTime,_that.rotationTime,_that.stations,_that.schedule,_that.endTime,_that.metadata,_that.templateId,_that.methodMd,_that.learningGoalsMd,_that.trainingFocusMd,_that.orderFormatMd,_that.executionTipsMd,_that.commsMd);case _:
  return null;
