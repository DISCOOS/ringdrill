...
/// denormalized identity).
 String? get personRef;// Markdown brief fields — stored as roleplays/<uuid>/<field>.md, not in JSON.
@JsonKey(includeFromJson: false, includeToJson: false) String? get propsMd;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RolePlay&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.index, index) || other.index == index)&&(identical(other.exerciseUuid, exerciseUuid) || other.exerciseUuid == exerciseUuid)&&(identical(other.name, name) || other.name == name)&&(identical(other.age, age) || other.age == age)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.description, description) || other.description == description)&&(identical(other.background, background) || other.background == background)&&(identical(other.behavior, behavior) || other.behavior == behavior)&&(identical(other.stationIndex, stationIndex) || other.stationIndex == stationIndex)&&(identical(other.position, position) || other.position == position)&&(identical(other.staffUuid, staffUuid) || other.staffUuid == staffUuid)&&(identical(other.personRef, personRef) || other.personRef == personRef)&&(identical(other.propsMd, propsMd) || other.propsMd == propsMd));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uuid,index,exerciseUuid,name,age,gender,description,background,behavior,stationIndex,position,staffUuid,personRef,propsMd);

@override
String toString() {
  return 'RolePlay(uuid: $uuid, index: $index, exerciseUuid: $exerciseUuid, name: $name, age: $age, gender: $gender, description: $description, background: $background, behavior: $behavior, stationIndex: $stationIndex, position: $position, staffUuid: $staffUuid, personRef: $personRef, propsMd: $propsMd)';
}
...
as LatLng?,staffUuid: freezed == staffUuid ? _self.staffUuid : staffUuid // ignore: cast_nullable_to_non_nullable
as String?,personRef: freezed == personRef ? _self.personRef : personRef // ignore: cast_nullable_to_non_nullable
as String?,propsMd: freezed == propsMd ? _self.propsMd : propsMd // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
switch (_that) {
case _RolePlay() when $default != null:
return $default(_that.uuid,_that.index,_that.exerciseUuid,_that.name,_that.age,_that.gender,_that.description,_that.background,_that.behavior,_that.stationIndex,_that.position,_that.staffUuid,_that.personRef,_that.propsMd);case _:
  return orElse();
...
switch (_that) {
case _RolePlay():
return $default(_that.uuid,_that.index,_that.exerciseUuid,_that.name,_that.age,_that.gender,_that.description,_that.background,_that.behavior,_that.stationIndex,_that.position,_that.staffUuid,_that.personRef,_that.propsMd);}
}
...
class _RolePlay implements RolePlay {
  const _RolePlay({required this.uuid, required this.index, required this.exerciseUuid, required this.name, this.age, this.gender, this.description, @JsonKey(includeFromJson: false, includeToJson: false) this.background, @JsonKey(includeFromJson: false, includeToJson: false) this.behavior, this.stationIndex, @NullableLatLngJsonConverter() this.position, this.staffUuid, this.personRef, @JsonKey(includeFromJson: false, includeToJson: false) this.propsMd});
...
@override final  String? staffUuid;
...
/// never emptied when a personRef is set (they hold the effective,
/// denormalized identity).
@override final  String? personRef;
// Markdown brief fields — stored as roleplays/<uuid>/<field>.md, not in JSON.
@override@JsonKey(includeFromJson: false, includeToJson: false) final  String? propsMd;
