...
acct_personal = _split(
    ...
    '''
            ...
            <div class="card">
              <div class="item"><i class="ti ti-users-group"></i><div class="grow"><div class="t">Make this an organisation</div><div class="s">To share these plans with colleagues who can publish updates</div></div></div>
            </div>
            ...
            <div style="border-top: 0.5px solid var(--color-border-tertiary); padding-top: 12px; display: flex; flex-direction: column; gap: 8px;">
              <div class="s" style="color: var(--danger-text);">Delete</div>
              <div class="item" style="padding-left: 0;"><i class="ti ti-trash" style="color: var(--danger-text);"></i><div class="grow"><div class="t" style="color: var(--danger-text);">Delete account and profile</div><div class="s">Deletes you as well: profile, sessions and memberships. Plans you published stay where they are &mdash; other people have installed them.</div></div></div>
            </div>''')
