...
acct_personal = _split(
    ...
    '''
            ...
            <div class="s"><b>The handle is the short name in your plans&rsquo; web addresses</b> &mdash; <code>ringdrill.app/d/kari-gulbrandsen/winter-drill</code> &mdash; and the name you give somebody so they can share a plan <i>with</i> you. Until one is claimed your plans publish under the account&rsquo;s id, which works and cannot be read back to you over a radio.</div>
