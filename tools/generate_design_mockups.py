...
acct_personal = _split(
    ...
    '''
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
              <div class="t">Run this account with other people</div>
              <div class="s">Members publish updates to every plan here, and appear as staff when you build a roster. The account gets a name of its own, so plans are published as the organisation rather than as you. Sharing a single plan with another account needs none of this — that already works. Inviting somebody makes this an organisation, and it cannot be undone by removing them again.</div>
