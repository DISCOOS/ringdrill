...
void main() {
  ...
  testWidgets('a section preview resolves co-occurring {{roleplay.*}} and '
      '{{exercise.*}} tokens together — a missing scope for one must not drag '
      'the whole field back to literal', (tester) async {
    await tester.binding.setSurfaceSize(const Size(800, 1200));
    addTearDown(() => tester.binding.setSurfaceSize(null));
      ...
      MaterialApp(
        ...
        home: RolePlayFormScreen(
          rolePlay: RolePlay(
            ...
            background:
                'Markøren heter {{roleplay.name}}. Det er totalt '
