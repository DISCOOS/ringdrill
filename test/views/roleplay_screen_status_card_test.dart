...
const _planUuid = 'prog-role-status-card';
...
void main() {
  ...
  testWidgets(
    'running: marker at station 2 on the last round falls back to the '
    'exercise finish time instead of an empty next-cell',
    (tester) async {
      ...
      ExerciseService().debugNowOverride = () => _fixedNow;
      addTearDown(() => ExerciseService().debugNowOverride = DateTime.now);
      // Round 2's teamIndex(2, 2) = team0 -> "Team 1" (still active this
