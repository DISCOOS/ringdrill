...
void main() {
  ...
  test('an overnight exercise keeps a valid currentRound once real time '
  ...
  test('currentRound never goes out of range for exercise.schedule across a '
    ...
    for (final minutes in [1, 5, 8, 9]) {
      ...
      expect(
        round,
        inInclusiveRange(0, _overnightExercise.schedule.length - 1),
      );
    }
