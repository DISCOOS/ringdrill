...
void main() {
  ...
  group('backward compatibility', () {
    test('program.json without variables deserializes to empty list', () {
      final program = Program.fromJson(minimalJson());
      expect(program.variables, isEmpty);
    });
  ...
  group('round-trips', () {
    test('Program registry round-trips through the real DrillFile archive',
        () {
      final program = base().copyWith(variables: [freq, meetingPoint]);
