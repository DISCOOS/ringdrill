...
* [ADR-0056: One drill player with peer modes — exercise, station, roleplay, team](../adrs/0056-player-modes-exercise-station-roleplay.md) — delivers the parked observer-player variants as modes of the single player instead of separate player shells.
