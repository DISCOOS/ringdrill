...
| ADR-0074 | Catalog entry as a distinct object, identified by `(namespace, slug)` (reserved, referenced by [ADR-0072](./0072-staff-pii-and-account-sync.md)) | Reserved |
| ADR-0075 | [Send mail through a provider adapter, and keep templates and events on our side](./0075-mail-provider-adapter.md) | Proposed |
