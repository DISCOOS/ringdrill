...
| ADR-0074 | [A catalog entry is a distinct object, identified by `(namespace, slug)` and defined by an allowlist](./0074-catalog-entry-as-distinct-object.md) | Proposed |
