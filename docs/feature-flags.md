...
| `RINGDRILL_PLAN_VARIABLES` | `bool` | Temporary | `false` | Gates the DESIGN-008 plan-variables feature (variable registry, section-navigated editor, token-aware fields) while it is built across stages. | [DESIGN-008](./design/008-plan-variables-and-section-navigated-editor.md) | Remove when all five DESIGN-008 stages have shipped and the feature is on by default. |
